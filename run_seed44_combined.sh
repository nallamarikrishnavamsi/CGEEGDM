...
#SBATCH --job-name=seed44_combined
#SBATCH --output=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/seed44_combined_%j.log
#SBATCH --error=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/seed44_combined_%j.err
