...
#SBATCH --job-name=gc_seed123
#SBATCH --output=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/gc_seed123_%j.log
#SBATCH --error=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/gc_seed123_%j.err
