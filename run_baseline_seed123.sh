...
#SBATCH --job-name=bl_seed123
#SBATCH --output=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/baseline_seed123_%j.log
#SBATCH --error=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/baseline_seed123_%j.err
