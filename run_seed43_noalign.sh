...
#SBATCH --job-name=seed43_noalign
#SBATCH --output=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/seed43_noalign_%j.log
#SBATCH --error=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/seed43_noalign_%j.err
