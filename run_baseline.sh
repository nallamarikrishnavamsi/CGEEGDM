...
#SBATCH --output=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/baseline_%j.log
#SBATCH --error=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/baseline_%j.err
