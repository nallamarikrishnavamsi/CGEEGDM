...
#SBATCH --job-name=seed44_baseline
#SBATCH --output=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/seed44_baseline_%j.log
#SBATCH --error=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/seed44_baseline_%j.err
