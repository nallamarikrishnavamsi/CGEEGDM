...
#SBATCH --job-name=noalign_seed39
#SBATCH --output=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/noalign_seed39_%j.log
#SBATCH --error=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/noalign_seed39_%j.err
