...
#SBATCH --job-name=gc_seed39
#SBATCH --output=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/gc_seed39_%j.log
#SBATCH --error=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/gc_seed39_%j.err
