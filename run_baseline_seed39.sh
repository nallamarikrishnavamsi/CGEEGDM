...
#SBATCH --job-name=bl_seed39
#SBATCH --output=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/baseline_seed39_%j.log
#SBATCH --error=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/baseline_seed39_%j.err
