...
#SBATCH --job-name=seed43_combined
#SBATCH --output=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/seed43_combined_%j.log
#SBATCH --error=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/seed43_combined_%j.err
