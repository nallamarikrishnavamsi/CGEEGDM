...
#SBATCH --output=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/pretrain_full106k_p2_%j.log
#SBATCH --error=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/pretrain_full106k_p2_%j.err
...
srun python src/pretrain_hms.py \
    ...
    --epochs 100 \
    --devices 2 \
    --resume_ckpt checkpoints/pretrain_full106k/last.ckpt
