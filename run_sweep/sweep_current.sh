...
#SBATCH --job-name=sweep_current
#SBATCH --output=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/sweep_current_%j.log
#SBATCH --error=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/sweep_current_%j.err
