...
#SBATCH --job-name=sweep_C
#SBATCH --output=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/sweep_C_%j.log
#SBATCH --error=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/sweep_C_%j.err
