...
#SBATCH --output=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/sweep_B_%j.log
#SBATCH --error=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/sweep_B_%j.err
