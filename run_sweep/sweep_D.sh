...
#SBATCH --job-name=sweep_D
#SBATCH --output=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/sweep_D_%j.log
#SBATCH --error=/home/dsamantaai/krishna/files/CGEEGDM_Final/logs/sweep_D_%j.err
